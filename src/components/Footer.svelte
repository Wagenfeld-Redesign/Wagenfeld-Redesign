...
>
	...
	<div class="self-center">
		...
		<p class="">
			© 2022 Hochschulprojekt des Studienganges: Medieninformatik im 4. Semester für die <span
				on:click={() => {
					window.open('https://hs-bremen.de', '_blank').focus();
				}}
			...
			<span
				on:click={() => {
					window.open('https://www.hs-bremen.de/person/ateufel/', '_blank').focus();
				}}
				class="link link-hover"
			>
				Prof. Andreas Teufel
	...
	<div>
		...
		<p
			class="link link-hover"
			on:click={() => {
				window.open('https://wilhelm-wagenfeld-stiftung.de/', '_blank').focus();
			}}
		>
	...
	<div class="self-center">
		<div class="flex gap-4">
			<p
				...
				on:click={() => {
					window.open('https://www.instagram.com/wilhelmwagenfeldhaus/', '_blank').focus();
				}}
			>
			...
			<p
				class="cursor-pointer"
				on:click={() => {
					window.open('https://www.facebook.com/WilhelmWagenfeldHaus/', '_blank').focus();
				}}
			>
				<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
					><path
